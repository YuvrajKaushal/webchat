    ...
    <div class="container">
      <div class="title">
        <mu-appbar color="primary">
          ...
          <div class="center">
            {{
              roomType === "group"
                ? `聊天(${Object.keys(roomUsers[roomid] || {}).length})`
                : friendName
            }}
          </div>
          <mu-button
      ...
      <div class="chat-inner" @scroll="bindScroll">
        <div class="chat-container">
          <div
            v-if="(roomdetail[roomid] || []).length === 0"
            class="chat-no-people"
          >
            暂无消息,赶紧来占个沙发～
          </div>
          <div
            v-if="(roomdetail[roomid] || []).length !== 0 && isloading"
            class="chat-loading"
          >
          ...
          <div
            v-if="isEnd && (roomdetail[roomid] || []).length !== 0"
            class="chat-top"
          >
            到顶啦~
          </div>
      ...
      <div class="bottom">
        ...
        <div class="chat">
          ...
          <mu-button class="demo-raised-button" color="primary" @click="submess"
            >发送</mu-button
          >
        </div>
        <input
