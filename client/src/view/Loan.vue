      ...
      <mu-paper>
        <mu-list>
          ...
          <mu-list-item
            ...
            button
            :ripple="true"
            @click="chatwindow('room1')"
          >
            <mu-list-item-action>
              <div class="avatar">
                <span class="tip" v-if="unRead1 !== 0">{{
                  unRead1 > 99 ? "99+" : unRead1
                }}</span>
          ...
          <mu-list-item
            ...
            button
            :ripple="true"
            @click="chatwindow('room2')"
          >
            <mu-list-item-action>
              <div class="avatar">
                <span class="tip" v-if="unRead2 !== 0">{{
                  unRead2 > 99 ? "99+" : unRead2
                }}</span>
        ...
        <mu-list>
          ...
          <mu-list-item avatar button :ripple="true" @click="chatRobot('')">
            ...
            <mu-list-item-title
              >客服大白(微信群，作者联系方式，找我)</mu-list-item-title
            >
            <mu-list-item-action>
              <mu-icon value="chat_bubble"></mu-icon>
            </mu-list-item-action>
        ...
        <mu-list>
          ...
          >
            ...
            <mu-list-item-content>
              ...
              <mu-list-item-sub-title>{{
                getSingleTailMsg(item.friendId._id)
              }}</mu-list-item-sub-title>
            </mu-list-item-content>
            <mu-list-item-action>
              <mu-icon value="chat_bubble"></mu-icon>
